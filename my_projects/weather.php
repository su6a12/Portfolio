  	...
  	<div class="container">
  		<div class="row center">
  			<div class="col-md-6 col-md-offset-3">
  				<h1>3 Day Weather Report</h1>

  				<form>
  					<div class="form-group">
  						<input type="text" id="city" class="form-control input-lg" placeholder="Enter a city...">
  					</div><!-- end of form-group -->
  				</form>

  				<button id="findCityBtn" class="btn btn-success btn-lg">Find My Weather</button>
